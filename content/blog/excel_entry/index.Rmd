...
Let's say, for the column `stu_id`, I know that these values should be numeric and should fall within the range of 14000 -- 15000. I can apply those rules to this column.
...
`=AND(ISNUMBER(A1),COUNTIF($A:$A, A1) = 1, A1 >=1400, A1<=1500)`
...
- https://corporatefinanceinstitute.com/resources/excel/index-match-formula-excel/
- https://www.excel-university.com/vlookup-hack-1-sort-order/
- https://mergeos.com/articles/learn/5-reasons-index-match-is-better-than-vlookup