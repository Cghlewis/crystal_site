...
8. Assign someone to oversee data management
    - While team science encourages trust and autonomy, it is still important to have one person assigned to oversee data management tasks. This person not only ensures that tasks are completed, but also checks to see if there is any internal drift occurring (staff members inconsistently following set standards). This role can also provide mentoring and feedback as needed to staff.
