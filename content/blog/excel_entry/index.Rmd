...
**Note:** *Before moving forward it's important to have a basic understanding of how data should be organized in a spreadsheet, and you can get a brief overview [here](https://datamgmtinedresearch.com/structure#basics-of-a-dataset).*
...
Creating a document like a [data dictionary](https://datamgmtinedresearch.com/document#document-dictionary) before you build your data entry form is an excellent way to think through what variables need to exist in your data entry sheet and what validation should be added to each column. 
...
What's nice about creating PivotTables in a new worksheet is that it reduces errors that might happen if you are sorting and filtering directly in your entry sheets.
