...
Last, when you are ready to share your clean data, it is crucial to always include documentation alongside your data to allow users to correctly interpret the information. The bare minimum documentation to share should include:
  1. [Project level documentation](https://datamgmtinedresearch.com/document.html#research-protocol) (contextual information about why and how your data was collected)
  ...
  2. A [data dictionary](https://datamgmtinedresearch.com/document.html#data-dictionary) that describes all relevant variable level information
