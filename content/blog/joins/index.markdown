...
**Note** In `dplyr` version 1.1.0 or higher, an additional argument was added, *relationship*. By adding this argument to your join, and specifying the correct type (e.g. _one-to-many_, _many-to-one_, _one-to-one_), you will receive an error if the join violates the constraints of the relationship. Read more [here](https://www.tidyverse.org/blog/2023/03/dplyr-1-1-1/).

**Note** We did not discuss _many-to-many_ relationships but if you want to see an example of one, you can see an example [here](https://gist.github.com/Cghlewis/3eaa0823770c2dd95067f1b9b5ee6837).
