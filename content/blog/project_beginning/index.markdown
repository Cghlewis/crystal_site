...
<img src="img/fig5-2.PNG" alt="Data Sources Catalog example" width="666" />
<p class="caption">Figure 1: Data Sources Catalog example</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="img/structure.jpg" alt="Example of an unorganized and an organized directory structure" width="80%" />
<p class="caption">Figure 2: Example of an unorganized and an organized directory structure</p>
</div>
...
**For paper files**
  - Design a similar [logical physical folder structure](https://datamgmtinedresearch.com/store#store-paper) for storing paper files that keeps data secure and allows team members to easily understand how to find appropriate files.
...
- Create a [data dictionary](https://datamgmtinedresearch.com/document#document-dictionary) for each unique instrument in your [data sources catalog](https://datamgmtinedresearch.com/dmp#dmp-catalog)
  - Each row of this rectangular formatted document will represent a variable that should exist in the final dataset for that source. Each column in that dictionary is an attribute about that variable (e.g., variable name, variable description, variable type, allowable values). This dictionary will be a compass for the remainder of your project, ensuring that you are always collecting, capturing, and cleaning data in a way that produces the datasets you planned for.
  
<div class="figure" style="text-align: center">
<img src="img/fig8-17.PNG" alt="Data Dictionary example" width="658" />
<p class="caption">Figure 3: Data Dictionary example</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="img/tracking.PNG" alt="Example tables in a participant tracking system" width="80%" />
<p class="caption">Figure 4: Example tables in a participant tracking system</p>
</div>
